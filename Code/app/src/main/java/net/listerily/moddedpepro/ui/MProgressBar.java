...
public class MProgressBar extends android.widget.ProgressBar {
    ...
    public MProgressBar(android.content.Context context) {
        super(context);
        mPaint = new Paint();
    ...
    public MProgressBar(android.content.Context context, android.util.AttributeSet attrs) {
        super(context, attrs);
        mPaint = new Paint();
        mPaint.setStyle(Paint.Style.FILL);
        mPaint.setColor(Color.parseColor("#FF2C9EF4"));
    ...
    public MProgressBar(android.content.Context context, android.util.AttributeSet attrs, int defStyleAttr) {
