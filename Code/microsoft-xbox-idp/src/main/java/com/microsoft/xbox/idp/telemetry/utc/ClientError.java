...
public class ClientError extends Data<CommonData> {
    ...
    public void writeNested(ProtocolWriter writer, boolean isBase) throws IOException {
        ...
        if (!canOmitFields || !this.errorText.equals(Schema.errorText_metadata.getDefault_value().getWstring_value())) {
        ...
        if (!canOmitFields || !this.errorCode.equals(Schema.errorCode_metadata.getDefault_value().getWstring_value())) {
        ...
        if (!canOmitFields || !this.callStack.equals(Schema.callStack_metadata.getDefault_value().getWstring_value())) {
        ...
        if (!canOmitFields || !this.pageName.equals(Schema.pageName_metadata.getDefault_value().getWstring_value())) {
    ...
    private boolean memberwiseCompareQuick(ClientError that) {
        Object obj;
                        ...
                        if (equals) {
                            ...
                            if (obj == (that.errorCode != null ? 1 : null)) {
                                ...
                                if (equals) {
                                    ...
                                    if (obj == (that.callStack != null ? 1 : null)) {
                                        equals = this.callStack == null || this.callStack.length() == that.callStack.length();
                                        if (equals) {
    ...
    private boolean memberwiseCompareDeep(ClientError that) {
        return (((((super.memberwiseCompareDeep(that)) && (this.errorName == null || this.errorName.equals(that.errorName))) && (this.errorText == null || this.errorText.equals(that.errorText))) && (this.errorCode == null || this.errorCode.equals(that.errorCode))) && (this.callStack == null || this.callStack.equals(that.callStack))) && (this.pageName == null || this.pageName.equals(that.pageName));
    }
}
