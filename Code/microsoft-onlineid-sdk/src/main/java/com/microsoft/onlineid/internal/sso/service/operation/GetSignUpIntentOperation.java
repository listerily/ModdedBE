...
public class GetSignUpIntentOperation extends ServiceOperation {
    public GetSignUpIntentOperation(Context applicationContext, Bundle params, AuthenticatorAccountManager accountManager, TicketManager ticketManager) {
    ...
    public Bundle call() {
        ...
        return BundleMarshaller.pendingIntentToBundle(getPendingIntentBuilder(AddAccountActivity.getSignUpIntent(getContext(), appProperties.toBundle(), getCallingPackage(), getCallerStateBundle())).setContext(getContext()).buildActivity());
    }
}
